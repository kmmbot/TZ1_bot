...
user_data = {
    "1234": {"name": "Пупкин Иван Иванович", "phone": "использовал свой телефон для тестирования", "balance": "550", "service":"Базовый", "cost": "1300", "payment": "0", "utilities":"Интернет и ТВ"}
}
